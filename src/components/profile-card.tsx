...
const ProfileCardComponent = ({
    avatarUrl = "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=500&q=80",
    iconUrl = "https://images.unsplash.com/photo-1547038576-665f0cd9f8ae?auto=format&fit=crop&w=500&q=80",
    grainUrl = "",
    innerGradient,
    ...
    }, [enableTilt, enableMobileTilt, tiltEngine, handlePointerEnter, handlePointerLeave, handlePointerMove, handleDeviceOrientation]);
        ...
        >
            {behindGlowEnabled && (
                <div
                    ...
                    style={{
                        background: `radial-gradient(circle at var(--pointer-x) var(--pointer-y), ${behindGlowColor ?? "rgba(125, 190, 255, 0.67)"} 0%, transparent ${behindGlowSize ?? "50%"})`,
            ...
            <div ref={shellRef} className="relative z-1 group">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div className="w-full absolute flex flex-col items-center" style={{ top: "3em", padding: "0 24px" }}>
                                <h3
